...
getTrendingMovies();
  ...
  return (
    ...
    <div className='flex overflow-x-auto w-full px-16 py-4 scrollbar-hide scroll-smooth' ref={elementRef}>
        ...
        <img src={IMAGE_BASE_URL + item.backdrop_path} className='min-w-full md:h-[390px] object-cover object-center mr-5 rounded-md hover:border-[4px] border-gray-400 transition-all ease-in-out duration-100'/>
        )}
        </div>
        </div>
)
